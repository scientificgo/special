...
func TestGammaRegQ(t *testing.T) { testutils.Test(t, tol, GammaRegQ, casesGammaRegQ) }
...
func TestGammaRegP(t *testing.T) { testutils.Test(t, tol, GammaRegP, casesGammaRegP) }
